...
public class VKPhotoAlbum extends VKAttachments.VKAttachment implements Parcelable, Identifiable {
     ...
     */
    public VKPhotoAlbum parse(JSONObject from) {
        id = from.optInt("id");
        ...
        if(sizes != null) {
            ...
            photo.add(VKPhotoSize.create(COVER_S, 75, 55));
            photo.add(VKPhotoSize.create(COVER_M, 130, 97));
            photo.add(VKPhotoSize.create(COVER_X, 432, 249));
            photo.sort();
        }
        return this;
    }
    ...
    public static Creator<VKPhotoAlbum> CREATOR = new Creator<VKPhotoAlbum>() {
        public VKPhotoAlbum createFromParcel(Parcel source) {
            return new VKPhotoAlbum(source);
        }

        public VKPhotoAlbum[] newArray(int size) {
            return new VKPhotoAlbum[size];
        }
    };
