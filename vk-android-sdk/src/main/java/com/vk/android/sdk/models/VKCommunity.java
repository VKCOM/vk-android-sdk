...
public class VKCommunity extends VKOwner implements android.os.Parcelable, Identifiable {
     ...
     * @see {@link com.vk.android.sdk.models.VKCommunity.Status}
     */
    ...
    /**
     * Community type
     * @see {@link com.vk.android.sdk.models.VKCommunity.Type}
     */
    public int type;
     ...
     */
    public VKCommunity parse(JSONObject from) {
        super.parse(from);
    ...
    public static Creator<VKCommunity> CREATOR = new Creator<VKCommunity>() {
        public VKCommunity createFromParcel(Parcel source) {
            return new VKCommunity(source);
        }

        public VKCommunity[] newArray(int size) {
            return new VKCommunity[size];
        }
    };
