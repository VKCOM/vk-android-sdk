...
public class VKApplicationContent extends VKAttachments.VKAttachment implements android.os.Parcelable {
     ...
     */
    public VKApplicationContent(Parcel in) {
        this.id = in.readInt();
    ...
    public static Creator<VKApplicationContent> CREATOR = new Creator<VKApplicationContent>() {
        public VKApplicationContent createFromParcel(Parcel source) {
            return new VKApplicationContent(source);
        }

        public VKApplicationContent[] newArray(int size) {
            return new VKApplicationContent[size];
        }
    };
