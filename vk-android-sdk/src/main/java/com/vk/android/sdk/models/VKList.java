...
public class VKList<T extends VKModel & Parcelable & Identifiable> implements java.util.List<T>,Parcelable {
     ...
     * @param <D> list item type.
     */
    public final static class ReflectParser<D extends VKModel> implements Parser<D> {
