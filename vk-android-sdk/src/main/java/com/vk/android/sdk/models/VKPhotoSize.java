 ...
 *
 */
public class VKPhotoSize extends VKModel implements Comparable<VKPhotoSize>, Parcelable, Identifiable {
    ...
    @Override
    public int compareTo(VKPhotoSize another) {
    ...
    public static Creator<VKPhotoSize> CREATOR = new Creator<VKPhotoSize>() {
        public VKPhotoSize createFromParcel(Parcel source) {
            return new VKPhotoSize(source);
        }

        public VKPhotoSize[] newArray(int size) {
            return new VKPhotoSize[size];
        }
    };
     ...
     */
    public static VKPhotoSize parse(JSONObject source, int originalWidth, int originalHeight) {
        VKPhotoSize result = new VKPhotoSize();
     ...
     */
    private static void fillDimensions(VKPhotoSize result, int originalWidth, int originalHeight) {
     ...
     */
    private static void fillDimensionSMXY(VKPhotoSize result, float ratio, int width) {
        result.width = width;
     ...
     */
    private static void fillDimensionOPQ(VKPhotoSize result, float ratio, int width) {
     ...
     */
    private static void fillDimensionZW(VKPhotoSize result, float ratio, int allowedWidth, int allowedHeight) {
     ...
     */
    public static VKPhotoSize create(String url, int width, int height) {
        VKPhotoSize result = new VKPhotoSize();
        result.src = url;
        result.width = width;
     ...
     */
    public static VKPhotoSize create(String url, char type, int originalWidth, int originalHeight) {
        VKPhotoSize result = new VKPhotoSize();
        result.src = url;
        result.type = type;
        fillDimensions(result, originalWidth, originalHeight);
     ...
     */
    public static VKPhotoSize create(String url, int dimension) {
