...
import static com.vk.android.sdk.models.ParseUtils.parseLong;

/**
 * Represents full user profile.
 */
@SuppressWarnings("unused")
public class VKUserFull extends VKUser implements android.os.Parcelable {
     ...
     */
    public VKList<VKUniversity> universities;

    /**
     * List of user's schools
     */
    public VKList<VKSchool> schools;
    ...
    /**
     * Views on policy.
     * @see {@link com.vk.android.sdk.models.VKUserFull.Political}
     */
    public int political;

    /**
     * Life main stuffs.
     * @see {@link com.vk.android.sdk.models.VKUserFull.LifeMain}
     */
    public int life_main;

    /**
     * People main stuffs.
     * @see {@link com.vk.android.sdk.models.VKUserFull.PeopleMain}
     */
    ...
    /**
     * User sex.
     * @see {@link com.vk.android.sdk.models.VKUserFull.Sex}
     */
    public int sex;
    ...
    /**
     * Relationship status.
     * @see {@link com.vk.android.sdk.models.VKUserFull.Relation}
     */
    public int relation;
    ...
    public VKUserFull parse(JSONObject user) {
        super.parse(user);
        ...
        // education
        universities = new VKList<VKUniversity>(user.optJSONArray(UNIVERSITIES), VKUniversity.class);
        schools = new VKList<VKSchool>(user.optJSONArray(SCHOOLS), VKSchool.class);
    ...
    public static class Relative extends VKModel implements android.os.Parcelable, Identifiable {
    ...
    public static Creator<VKUserFull> CREATOR = new Creator<VKUserFull>() {
        public VKUserFull createFromParcel(Parcel source) {
            return new VKUserFull(source);
        }

        public VKUserFull[] newArray(int size) {
            return new VKUserFull[size];
        }
    };
}
