...
public class ParseUtils {
     ...
     *  arrays of primitive types, {@link java.lang.String}s and {@link com.vk.android.sdk.models.VKModel}s,
     *  list implementation line {@link com.vk.android.sdk.models.VKList}, {@link com.vk.android.sdk.models.VKAttachments.VKAttachment} or {@link com.vk.android.sdk.models.VKPhotoSizes},
     *  {@link com.vk.android.sdk.models.VKModel}s.
     *
            ...
            try {
                if (fieldType.isPrimitive() && value instanceof Number) {
                    ...
                    if (value.getClass().equals(fieldType)) {
                        ...
                        if(VKModel.class.isAssignableFrom(genericType) && Parcelable.class.isAssignableFrom(genericType) && Identifiable.class.isAssignableFrom(genericType)) {
                    ...
                    } else if (VKModel.class.isAssignableFrom(fieldType) && value instanceof JSONObject) {
                        result = ((VKModel) fieldType.newInstance()).parse((JSONObject) value);
                    }
                ...
                // Вы не поверите, но к некоторых вендоров getFields() вызывает ВОТ ЭТО.
     ...
     * Supports parsing of primitive types and {@link com.vk.android.sdk.models.VKModel} instances.
    ...
    public static Object parseArrayViaReflection(JSONArray array, Class arrayClass) throws JSONException {
        ...
        for (int i = 0; i < array.length(); i++) {
            try {
                ...
                if(VKModel.class.isAssignableFrom(subType) && item instanceof JSONObject) {
                    VKModel model = (VKModel) subType.newInstance();
